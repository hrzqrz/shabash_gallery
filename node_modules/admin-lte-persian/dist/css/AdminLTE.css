...
@media (max-width: 991px) {
  ...
  .navbar-collapse.pull-right + .navbar-custom-menu {
    display: block;
    position: absolute;
    top: 0;
    left: 40px;
...
.sidebar-menu li > a > .pull-left-container > .fa-angle-right {
  width: auto;
  height: auto;
  padding: 0;
  margin-left: 10px;
...
.sidebar-menu .menu-open > a > .pull-left-container > .fa-angle-right {
...
.sidebar-mini:not(.sidebar-mini-expand-feature).sidebar-collapse .sidebar-menu > li:hover > a > span:not(.pull-left),
...
.sidebar-mini:not(.sidebar-mini-expand-feature).sidebar-collapse .sidebar-menu > li:hover > a > .pull-left-container {
...
.sidebar-mini:not(.sidebar-mini-expand-feature).sidebar-collapse .sidebar-menu > li:hover > a > .pull-left-container > .label:not(:first-of-type) {
  display: none;
}
.sidebar-mini:not(.sidebar-mini-expand-feature).sidebar-collapse .sidebar-menu > li:hover > .treeview-menu {
  top: 44px;
...
/*
 * Component: Control sidebar. By default, this is the left sidebar.
 */
.control-sidebar-bg {
  position: fixed;
  z-index: 1000;
...
@media (min-width: 768px) {
  ...
  .control-sidebar-open .left-side,
...
.treeview-menu > li > a > .pull-left-container > .fa-angle-right,
.treeview-menu > li > a > .pull-left-container > .fa-angle-down,
 ...
 *
 * Copyleft 2013-2015 Panayiotis Lipiridis
