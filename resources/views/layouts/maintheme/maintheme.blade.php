...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="css/maintheme/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <!-- shop css -->
    <link href="css/maintheme/shop.css" type="text/css" rel="stylesheet" media="all">
    <link rel="stylesheet" href="css/maintheme/owl.carousel.min.css">
    <!-- Owl-Carousel-CSS -->
    <link href="css/maintheme/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="css/maintheme/fontawesome-all.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
	{{-- <link href="//fonts.googleapis.com/css?family=Elsie+Swash+Caps:400,900" rel="stylesheet"> --}}
	<link rel="stylesheet" href="css/maintheme/google-fonts-1.css">
	{{-- <link href="//fonts.googleapis.com/css?family=Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i" rel="stylesheet"> --}}
	<link rel="stylesheet" href="css/maintheme/google-fonts-2.css">
	{{-- <script src='https://kit.fontawesome.com/a076d05399.js'></script> --}}
	<script src="js/maintheme/w3schools-icons-fonts.js"></script>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="index.html">شاباش
                    </a>
                </h1>
                <!-- //logo -->
                <div class="w3ls_right_nav ml-auto d-flex">
                    ...
                    <form class="nav-search form-inline my-0 form-control" action="#" method="post">
                        <select class="form-control input-lg" name="category">
                            <option value="all">جستجوی کالا</option>
                            <optgroup label="Mens">
                        ...
                        <input class="btn btn-outline-secondary  ml-3 my-sm-0" type="submit" value="جستجو">
                    </form>
                    <!-- search form -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light justify-content-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto text-center">
                        <li class="nav-item">
                            <a class="nav-link  active" href="index.html">صفحه اصلی
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">حلقه های نامزدی </a>
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">حلقه های ازدواج </a>
                            <div class="dropdown-menu" style="width:100%">
                                <div class="px-0 container">
                                    <div class="row">
                                        <div class="col-md-4">
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">ست های نامزدی </a>
                            <div class="dropdown-menu" style="width:100%">
                                <div class="container">
            ...
            <ul class="rslides" id="slider3">
                <li class="banner">
                    <div class="container">
                        ...
                        <h4 class="w3_bbot">بورس تخصصی انگشتر</h4>
                        <div class="slider-info mt-sm-5">
                            <h4 class="bn_right">
                                <span>ا</span>نگشترهای
                                <span>ن</span>امزدی</h4>
    ...
    <div class="agileits-services" id="services">
        <div class="no-gutters agileits-services-row row">
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                ...
                <h4 class="mt-2 mb-3">ست های حلقه ازدواج</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-gift p-4"></span>
                <h4 class="mt-2 mb-3">ست های حلقه نامزدی</h4>
            </div>

            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-lock p-4"></span>
                <h4 class="mt-2 mb-3">حلقه نامزدی</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-shipping-fast p-4"></span>
                <h4 class="mt-2 mb-3">حلقه ازدواج</h4>
            </div>
        </div>
    </div>
    <!-- //services-->
                        ...
                        <div class="col-lg-3 col-sm-6 footer-v2grid mt-sm-0 mt-5">
                            ...
                            <div class="footer-v2grid1 row">
                                <div class="col-4 footer-v2grid1-left">
                                    <a href="blog.html">
									<img src="{{ asset('images/maintheme/bl2.jpg') }}" alt=" " class="img-fluid">
                                    </a>
                                </div>
    ...
    <!-- signin Modal -->
    <!-- js -->
    <script src="js/maintheme/jquery-2.2.3.min.js"></script>
    <!-- //js -->
    ...
    <script src="js/maintheme/responsiveslides.min.js"></script>
    <script>
    ...
    <script src="js/maintheme/owl.carousel.js"></script>
    <script>
    ...
    <!-- //Product slider Owl-Carousel-JavaScript -->
    <!-- cart-js -->
    <script src="js/maintheme/minicart.js">
    </script>
    <script>
        hub.render();
    ...
    <script src="js/maintheme/move-top.js"></script>
    <script src="js/maintheme/easing.js"></script>
    <script>
    ...
    <script src="js/maintheme/SmoothScroll.min.js"></script>
    <!-- //smooth-scrolling-of-move-up -->
    <!-- Bootstrap core JavaScript
================================================== -->
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="js/maintheme/bootstrap.js"></script>
</body>
